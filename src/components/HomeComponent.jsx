                ...
                <div className="flex items-center justify-center h-screen bg-gray-100">
                    <div className="w-[500px] bg-white border border-gray-200 rounded-md shadow-md p-5">
                        ...
                        <form onSubmit={handleSubmit} className='flex flex-col mt-5'>
                            ...
                            <button type='submit' className='bg-blue-100 p-5 text-lg font-bold rounded-md mt-3 cursor-pointer duration-300 hover:bg-blue-300 hover:text-white'>Join Room</button>
                        </form>
                    </div>  
                </div>
        </>
